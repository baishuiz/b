Air.Module('B.directive.model', function(require:any) {
  ...
  function getTargetIndex(checkedList:any, target:any, selector:any, context:any) {
  ...
  function setScopeData(dataPath:any, value:any, scope:any) {
